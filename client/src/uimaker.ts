export interface Node {
  ...
  /**
   *
   * @param listener A function that will be called every time the node receive an input. The argument is the `msg.payload` from NodeRED.
   */
  subscribe: (
 ...
 */
export const configure = (host: string): createNode => (identifier: string) => {
